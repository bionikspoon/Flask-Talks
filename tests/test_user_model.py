...
class UserModelTestCase(unittest.TestCase):
    ...
    def test_gravatar(self):
        ...
        http_gravatar = '{}{}'.format('http://www.gravatar.com/avatar/',
                                      'd4c74594d841139328695756648b6bd6')

        self.assertTrue(http_gravatar in gravatar)
        self.assertTrue('s=256' in gravatar_256)
        self.assertTrue('r=pg' in gravatar_pg)
        self.assertTrue('d=retro' in gravatar_retro)
        https_gravatar = '{}{}'.format('https://secure.gravatar.com/avatar/',
                                       'd4c74594d841139328695756648b6bd6')
        self.assertTrue(https_gravatar in gravatar_ssl)
    ...
    def test_moderation(self):
        ...
        c1 = Comment(talk=t, body='c1', author_name='n', author_email='e@e.com',
                     approved=True)
        c2 = Comment(talk=t, body='c2', author_name='n', author_email='e@e.com',
                     approved=False)
